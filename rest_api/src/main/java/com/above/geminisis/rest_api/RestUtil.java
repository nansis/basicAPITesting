...
public class RestUtil {
	 public static String path; //Rest request path
	    ...
	    */
	    ...
	    public static void  createQueryPath(String searchTerm, String jsonPathTerm) {
	        path = searchTerm + "/" + jsonPathTerm ;
	    }
	    
	    public static void  createQueryPath(String searchTerm) {
	        path = searchTerm  ;
	    }
	    /*
	    ***Returns response***
	    ...
	    */
	    ...
	    public static Response postResponse (Response res){
